...
set ticslevel 0
set view 70,30
splot [-0.2:1.4][-0.6:0.6][-0.15:0.15] input using 5:6:7 with lines, '' using 8:9:10 with lines
...
set key at 9.8,0.55
set datafile separator " "
plot [0:10][-1.05:0.8] input using 1:2 t 'Kinetic energy' with lines, '' using 1:3 t 'Potential energy' with lines, '' using 1:4 t 'Total energy' with lines
